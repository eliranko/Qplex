...
{
    [TestClass]
    public class FramingAlgorithmInt16Tests
    {
        ...
        {
            _framingAlgorithm = new FramingAlgorithmInt16();
        ...
        public void FrameBufferReturnsCorrectBuffer()
        {
            ...
            Assert.IsTrue(new byte[] { 2, 0, 1, 2 }.SequenceEqual(buffer));
        }
        ...
        {
            var frame = _framingAlgorithm.UnframeBuffer(new byte[] { 2, 0, 1, 2 });
